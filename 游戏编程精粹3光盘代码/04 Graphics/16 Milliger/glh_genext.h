...
# define GLH_CORE_1_2_NAME(a) GLH__PREPROCESSOR_GYMNASTICS(GLH_CORE_1_2_PREFIX,a)
    ...
    GLH_EXTERN PFNGLPROGRAMLOCALPARAMETER4FNVPROC GLH_EXT_NAME(glProgramLocalParameter4fNV) GLH_INITIALIZER;
    GLH_EXTERN PFNGLPROGRAMLOCALPARAMETER4DNVPROC GLH_EXT_NAME(glProgramLocalParameter4dNV) GLH_INITIALIZER;
    GLH_EXTERN PFNGLPROGRAMLOCALPARAMETER4FVNVPROC GLH_EXT_NAME(glProgramLocalParameter4fvNV) GLH_INITIALIZER;
    GLH_EXTERN PFNGLPROGRAMLOCALPARAMETER4DVNVPROC GLH_EXT_NAME(glProgramLocalParameter4dvNV) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETPROGRAMLOCALPARAMETERFVNVPROC GLH_EXT_NAME(glGetProgramLocalParameterfvNV) GLH_INITIALIZER;
    GLH_EXTERN PFNGLGETPROGRAMLOCALPARAMETERDVNVPROC GLH_EXT_NAME(glGetProgramLocalParameterdvNV) GLH_INITIALIZER;
#endif
...
int glh_init_extension(const char* extension)
{
    if (NULL == extension) {
        ...
        GLH_EXT_NAME(glProgramLocalParameter4fNV) = (PFNGLPROGRAMLOCALPARAMETER4FNVPROC)GLH_EXT_GET_PROC_ADDRESS("glProgramLocalParameter4fNV");
        if (NULL == GLH_EXT_NAME(glProgramLocalParameter4fNV))
            return GL_FALSE;
        GLH_EXT_NAME(glProgramLocalParameter4dNV) = (PFNGLPROGRAMLOCALPARAMETER4DNVPROC)GLH_EXT_GET_PROC_ADDRESS("glProgramLocalParameter4dNV");
        if (NULL == GLH_EXT_NAME(glProgramLocalParameter4dNV))
            return GL_FALSE;
        GLH_EXT_NAME(glProgramLocalParameter4fvNV) = (PFNGLPROGRAMLOCALPARAMETER4FVNVPROC)GLH_EXT_GET_PROC_ADDRESS("glProgramLocalParameter4fvNV");
        if (NULL == GLH_EXT_NAME(glProgramLocalParameter4fvNV))
            return GL_FALSE;
        GLH_EXT_NAME(glProgramLocalParameter4dvNV) = (PFNGLPROGRAMLOCALPARAMETER4DVNVPROC)GLH_EXT_GET_PROC_ADDRESS("glProgramLocalParameter4dvNV");
        if (NULL == GLH_EXT_NAME(glProgramLocalParameter4dvNV))
            return GL_FALSE;
        GLH_EXT_NAME(glGetProgramLocalParameterfvNV) = (PFNGLGETPROGRAMLOCALPARAMETERFVNVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetProgramLocalParameterfvNV");
        if (NULL == GLH_EXT_NAME(glGetProgramLocalParameterfvNV))
            return GL_FALSE;
        GLH_EXT_NAME(glGetProgramLocalParameterdvNV) = (PFNGLGETPROGRAMLOCALPARAMETERDVNVPROC)GLH_EXT_GET_PROC_ADDRESS("glGetProgramLocalParameterdvNV");
        if (NULL == GLH_EXT_NAME(glGetProgramLocalParameterdvNV))
            return GL_FALSE;
#endif
...
#ifdef GL_NV_fragment_program
#define glProgramLocalParameter4fNV GLH_EXT_NAME(glProgramLocalParameter4fNV)
#define glProgramLocalParameter4dNV GLH_EXT_NAME(glProgramLocalParameter4dNV)
#define glProgramLocalParameter4fvNV GLH_EXT_NAME(glProgramLocalParameter4fvNV)
#define glProgramLocalParameter4dvNV GLH_EXT_NAME(glProgramLocalParameter4dvNV)
#define glGetProgramLocalParameterfvNV GLH_EXT_NAME(glGetProgramLocalParameterfvNV)
#define glGetProgramLocalParameterdvNV GLH_EXT_NAME(glGetProgramLocalParameterdvNV)
#endif
