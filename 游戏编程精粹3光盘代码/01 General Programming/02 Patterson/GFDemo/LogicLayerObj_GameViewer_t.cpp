...
// LogicLayerObj_GameViewer_t.cpp: implementation of the LogicLayerObj_GameViewer_t class.
//
//////////////////////////////////////////////////////////////////////
...
LogicLayerObj_GameViewer_t::LogicLayerObj_GameViewer_t()
{
	m_pSystems = 0;
	m_bExclusive = true;
}
...
bool LogicLayerObj_GameViewer_t::Connect( Systems_t *pSystems )
{
	m_pSystems = pSystems;

	ResourceSys_t *pResourceSys = m_pSystems->GetResourceSys();
	m_pAVLayer = (AVLayerObj_GameViewer_t *)pResourceSys->GetAVLayer( INSTANCE_ID_AVLAYER_GAMEVIEWER );

	return true;
}

void LogicLayerObj_GameViewer_t::Disconnect()
{
}

void LogicLayerObj_GameViewer_t::Update()
{
...
void LogicLayerObj_GameViewer_t::SetExclusive( bool bEnable )
{
	m_bExclusive = bEnable;
}

bool LogicLayerObj_GameViewer_t::IsExclusive()
{
	return m_bExclusive;
}
