...
#define TESTFULL(name,classUnderTest,setupName)\
	class classUnderTest##name##Test : public Test, setupName\
	{ \
		public: \
			classUnderTest##name##Test () : Test (#name "Test") {} \
            void setup() {setupName::setup();} \
            void teardown() {setupName::teardown();} \
			void runTest (TestResult& result_); \
	} classUnderTest##name##Instance; \
	void classUnderTest##name##Test::runTest (TestResult& result_) \
