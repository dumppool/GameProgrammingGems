// GANoiseMSineOsc Implementation
// --------------------------------------------------------------------------------------------------------
// System:		ATOMGAUD
...
void* __stdcall CreateCGANoiseMSineOsc() { return( new CGANoiseMSineOsc); }
const CClass CGANoiseMSineOsc::classCGANoiseMSineOsc(CID_GANoiseMSineOsc, CID_GAOscillator, "CGANoiseMSineOsc", CreateCGANoiseMSineOsc);
const IClass*	CGANoiseMSineOsc::GetClass() { return((const IClass*)&classCGANoiseMSineOsc); }


// CTOR
CGANoiseMSineOsc::CGANoiseMSineOsc()
{
	SetName("NoiseMSineOsc");
...
void CGANoiseMSineOsc::Terminate()
{
...
UINT32 CGANoiseMSineOsc::Process(IObject* pob)
{
	...
	for( UINT32 i=0; i< nFrames; i++ )
	{
		...
		FLOAT32 fDamp = 0.5f;
		FLOAT32 fRand = m_Random.ExponentialU() * (1.0f - fDamp) + (fr *fDamp);
		fr = fRand ;
