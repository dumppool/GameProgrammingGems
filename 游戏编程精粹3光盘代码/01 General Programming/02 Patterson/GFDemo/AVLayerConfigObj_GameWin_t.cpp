...
// AVLayerConfigObj_GameWin_t.cpp: implementation of the AVLayerConfigObj_GameWin_t class.
//
//////////////////////////////////////////////////////////////////////
...
AVLayerConfigObj_GameWin_t::AVLayerConfigObj_GameWin_t()
{
...
void AVLayerConfigObj_GameWin_t::Configure( AVLayer_t *pAVLayer )
{
	AVLayerObj_GameWin_t *pAVLayerObj = (AVLayerObj_GameWin_t *)pAVLayer;
	...
	pAVLayerObj->m_ModeTextBox.m_Text = "GameWin";
