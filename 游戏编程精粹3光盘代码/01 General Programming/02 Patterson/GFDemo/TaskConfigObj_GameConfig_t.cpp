...
// TaskConfigObj_GameConfig_t.cpp: implementation of the TaskConfigObj_GameConfig_t class.
//
//////////////////////////////////////////////////////////////////////
...
TaskConfigObj_GameConfig_t::TaskConfigObj_GameConfig_t()
{
...
void TaskConfigObj_GameConfig_t::Configure( Task_t *pTask, Systems_t *pSystems )
{
	...
	pAVLayer = pResourceSys->GetAVLayer( INSTANCE_ID_AVLAYER_GAMECONFIG );
	pFramePlayer->Post_AVLayerCommand( AVLayerCommand_t::PUSH_BACK, pAVLayer );

	pLogicLayer = pResourceSys->GetLogicLayer( INSTANCE_ID_LOGICLAYER_GAMECONFIG );
