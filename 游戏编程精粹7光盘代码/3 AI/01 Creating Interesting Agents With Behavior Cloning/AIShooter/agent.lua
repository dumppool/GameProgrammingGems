...
function turnTree ()
    if (GameState.opp_dir_to < 6) then
        Agent.turn ("right");
    elseif (GameState.opp_dir_to > 7) then
        Agent.turn ("left");
    else
        Agent.turn ("none");
    end
...
function accelTree ()
    if (GameState.opp_distance < 1) then
        if (GameState.opp_dir_from >= 5 and GameState.opp_dir_from <= 8) then
            Agent.accel ("reverse");
        else
            Agent.accel ("none");
        end
    elseif (GameState.opp_distance > 1) then
        Agent.accel ("normal");
    else
        Agent.accel ("none");
    end
...
function fireTree ()
    if (GameState.opp_distance < 8) then
        if (GameState.opp_dir_to >= 5 and GameState.opp_dir_to <= 8) then
            Agent.fire ("fire");
        else
            Agent.fire ("none");
        end
