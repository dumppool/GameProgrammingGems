...
// TaskConfigObj_SystemConfig_t.cpp: implementation of the TaskConfigObj_SystemConfig_t class.
//
//////////////////////////////////////////////////////////////////////
...
TaskConfigObj_SystemConfig_t::TaskConfigObj_SystemConfig_t()
{
...
void TaskConfigObj_SystemConfig_t::Configure( Task_t *pTask, Systems_t *pSystems )
{
	...
	pAVLayer = pResourceSys->GetAVLayer( INSTANCE_ID_AVLAYER_SYSTEMCONFIG );
	pFramePlayer->Post_AVLayerCommand( AVLayerCommand_t::PUSH_BACK, pAVLayer );

	pLogicLayer = pResourceSys->GetLogicLayer( INSTANCE_ID_LOGICLAYER_SYSTEMCONFIG );
