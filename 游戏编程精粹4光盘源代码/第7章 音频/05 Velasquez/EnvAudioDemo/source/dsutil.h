...
public:
	...
	HRESULT InitializeListenerAttributes( void );
	HRESULT SetEnvironment( void );	// TODO: Add environment class as parameter
	HRESULT SetNextEnvironment(void);
