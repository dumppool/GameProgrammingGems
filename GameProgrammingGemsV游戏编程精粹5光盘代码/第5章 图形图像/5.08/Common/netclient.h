...
{
public:
    CNetClientWizard( HINSTANCE hInst, LPCTSTR strAppName, GUID* pGuidApp );
    ...
    void    SetPlayerName( LPCTSTR strPlayerName ) { _tcsncpy( m_strLocalPlayerName, strPlayerName, MAX_PATH-1 ); m_strLocalPlayerName[ MAX_PATH-1 ] = 0; }
