...
CNetConnectWizard::CNetConnectWizard( HINSTANCE hInst, HWND hWndParent, 
                                      LPCTSTR strAppName, GUID* pGuidApp )
{
    g_pNCW              = this;
    m_hInst             = hInst;
        ...
        case DPL_MSGID_CONNECT:
        {
            ...
            else
            {
                ...
                if( pSettings->pwszPlayerName != NULL )
                {
                    ...
                    _tcsncpy( m_strLocalPlayerName, strPlayerName, MAX_PLAYER_NAME-1 );
                }
                else
                {
                    _tcsncpy( m_strLocalPlayerName, TEXT("Unknown"), MAX_PLAYER_NAME-1 );
                }
